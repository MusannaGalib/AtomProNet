...
# Ask for the root directory where the OUTCAR files are located
root_directory = input("Please provide the root directory where the OUTCAR files are located: ").strip()

# Define a function that processes a single folder containing an OUTCAR file.
...
# Loop over all subdirectories under the given root directory
